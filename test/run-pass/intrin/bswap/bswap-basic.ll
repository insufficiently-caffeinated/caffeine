...
define dso_local void @test(i32 %0) local_unnamed_addr #0 {
  %2 = icmp eq i32 16909060, %0 ; 0x01020304
  call void @caffeine_assume(i1 zeroext %2)
  %3 = call i32 @llvm.bswap.i32(i32 %0)
  %4 = icmp eq i32 67305985, %3 ; 0x04030201
...
declare void @caffeine_assume(i1 zeroext) local_unnamed_addr #1
